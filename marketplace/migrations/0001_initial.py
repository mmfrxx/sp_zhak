    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_status', models.CharField(choices=[('In Progress', 'In progress'), ('Complete', 'Complete'), ('For Return', 'For Return'), ('Returned', 'Returned'), ('In Cart', 'In Cart')], default='In progress', max_length=16)),
